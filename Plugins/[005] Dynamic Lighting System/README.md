...
A comprehensive dynamic lighting plugin for **Pokémon Essentials v21.1** (RPG Maker XP / mkxp).  
Adds circle, rectangle, cone, and bitmap-based light sources with 80+ visual effects,  
particle systems, weather integration, and gameplay mechanics.
...
7. [Event Comment Tags](#event-comment-tags)
8. [PBS Light Import](#pbs-light-import)
9. [LightEffect Attributes](#lighteffect-attributes)
10. [Flashlight System](#flashlight-system)
11. [Feature Reference](#feature-reference)
12. [Debug Tools](#debug-tools)
13. [Night Tilesets](#night-tilesets)
