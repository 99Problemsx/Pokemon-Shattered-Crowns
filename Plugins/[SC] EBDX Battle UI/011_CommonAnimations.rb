#===============================================================================
#  [SC] EBDX Battle UI - Common Animations (1:1 port from EBDX)
#  All EliteBattle. calls replaced with EBDXAnimations.
#  Original source: Elite Battle DX / [002] Animation Code / Common Animations
#===============================================================================
#===============================================================================
#  Common Animation: ATTRACT
#===============================================================================
EBDXAnimations.defineCommonAnimation(:ATTRACT) do
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:AURAFLARE) do
  #-----------------------------------------------------------------------------
  #  hides UI elements
...
#  BIRDSPLASH
#-------------------------------------------------------------------------------
EBDXAnimations.defineCommonAnimation(:BIRDSPLASH) do
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:BURN) do
  #-----------------------------------------------------------------------------
  #  configure variables
...
#  CLAMP	
#-------------------------------------------------------------------------------
EBDXAnimations.defineCommonAnimation(:CLAMP) do
  vector = @scene.getRealVector(@targetIndex, @targetIsPlayer)
  factor = @targetIsPlayer ? 2 : 1.5
  # set up animation
  fp = {}
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:CONFUSION) do
  #-----------------------------------------------------------------------------
  #  configure variables
  @scene.wait(16, true) if @scene.afterAnim
  fp = {}; k = -1
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:DISTORTION) do
  @scene.wait(2)
  # initial metrics
...
#  EXPLOSION_SELF
#-------------------------------------------------------------------------------
EBDXAnimations.defineCommonAnimation(:EXPLOSION_SELF) do
  @vector.set(@scene.getRealVector(@userIndex, @userIsPlayer))
  @scene.wait(7,true)
...
#  EXPLOSION
#-------------------------------------------------------------------------------
EBDXAnimations.defineCommonAnimation(:EXPLOSION) do
  @vector.set(@scene.getRealVector(@targetIndex, @targetIsPlayer))
  @scene.wait(7,true)
  cx, cy = @targetSprite.getCenter(true)
  dx = []
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:FIRESPIN) do
  #-----------------------------------------------------------------------------
  #  configure variables
  @scene.wait(16, true) if @scene.afterAnim
  fp = {}; rndx = []; rndy = []; shake = 2; k = -1
...
#  FOCUSPUNCH
#-------------------------------------------------------------------------------
EBDXAnimations.defineCommonAnimation(:FOCUSPUNCH) do
  vector = @scene.getRealVector(@targetIndex, @targetIsPlayer)
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:FORMCHANGE) do | pokemon |
  #-----------------------------------------------------------------------------
  #  transition sprite
  10.times do
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:FROZEN) do
  #-----------------------------------------------------------------------------
  #  configure variables
  @scene.wait(16, true) if @scene.afterAnim
  fp = {}; rndx = []; rndy = []; k = -1
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:GRUDGE) do
  #-----------------------------------------------------------------------------
  #  configure variables
  @scene.wait(16, true) if @scene.afterAnim
  fp = {}; rndx = []; rndy = []; shake = 2; k = -1
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:HEALTHUP) do
  #-----------------------------------------------------------------------------
  #  configure variables
  @scene.wait(16, true) if @scene.afterAnim
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:INFESTATION) do
  # configure animation
  @scene.wait(16,true)
  factor = @targetSprite.zoom_x
  cx, cy = @targetSprite.getCenter(true)
...
#  LEECHSEED
#-------------------------------------------------------------------------------
EBDXAnimations.defineCommonAnimation(:LEECHSEED) do | args |
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:MEGAEVOLUTION2) do
  #-----------------------------------------------------------------------------
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:NIGHTMARE) do
  #-----------------------------------------------------------------------------
  #  configure variables
  @scene.wait(16, true) if @scene.afterAnim
  fp = {}; rndx = []; rndy = []; shake = 2; k = -1
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:PARALYSIS) do
  #-----------------------------------------------------------------------------
  #  configure variables
  @scene.wait(16, true) if @scene.afterAnim
  fp = {}; k = -1
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:POISON) do
  #-----------------------------------------------------------------------------
  #  configure variables
  @scene.wait(16, true) if @scene.afterAnim
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:ROAR) do
  #-----------------------------------------------------------------------------
  fp = {}
  #-----------------------------------------------------------------------------
  #  vector config
...
#  ROCKSPLASH
#-------------------------------------------------------------------------------
EBDXAnimations.defineCommonAnimation(:ROCKSPLASH) do
  vector = @scene.getRealVector(@targetIndex, @targetIsPlayer)
  factor = @targetIsPlayer ? 2 : 1.5
  # set up animation
  fp = {}
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:SANDTOMB) do
  #-----------------------------------------------------------------------------
  #  configure variables
  @scene.wait(16, true) if @scene.afterAnim
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:SHADOWAURA) do
  #-----------------------------------------------------------------------------
  #  hides UI elements
  @scene.pbHideAllDataboxes
  fp = {}
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:SHINY) do
  #-----------------------------------------------------------------------------
  #  configure variables
  @scene.wait(16, true) if @scene.afterAnim
  fp = {}; k = -1
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:SLEEP) do
  #-----------------------------------------------------------------------------
  #  configure variables
  @scene.wait(16, true) if @scene.afterAnim
  fp = {}; r = []
...
#  SPARKLE_YELLOW
#-------------------------------------------------------------------------------
EBDXAnimations.defineCommonAnimation(:SPARKLE_YELLOW) do
  # configure animation
  @vector.set(@scene.getRealVector(@targetIndex, @targetIsPlayer))
  @scene.wait(16,true)
  factor = @targetSprite.zoom_x
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:STATDOWN) do
  #-----------------------------------------------------------------------------
  #  configure variables
  @scene.wait(16, true) if @scene.afterAnim
  pt = {}; rndx = []; rndy = []; tone = []; timer = []; speed = []
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:STATUP) do
  #-----------------------------------------------------------------------------
  #  configure variables
  @scene.wait(16, true) if @scene.afterAnim
  pt = {}; rndx = []; rndy = []; tone = []; timer = []; speed = []
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:SUBSTITUTE) do | targets, set |
  #-----------------------------------------------------------------------------
  #  transition sprites
  8.times do
    for t in targets
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:TOXIC) do
  #-----------------------------------------------------------------------------
  #  configure variables
  @scene.wait(16, true) if @scene.afterAnim
  fp = {}; shake = 1; k = -0.1; inc = 1
...
#  Common Animation: HEALTHUP
#===============================================================================
EBDXAnimations.defineCommonAnimation(:USEITEM) do
  #-----------------------------------------------------------------------------
  #  configure variables
  @scene.wait(16, true) if @scene.afterAnim
  pt = {}; rndx = []; rndy = []; tone = []; timer = []; speed = []
...
#===============================================================================
EBDXAnimations.defineCommonAnimation(:WHIRLPOOL) do
  #-----------------------------------------------------------------------------
  #  configure variables
  @scene.wait(16, true) if @scene.afterAnim
  fp = {}; rndx = []; rndy = []; shake = 2; k = -1
...
#  WRAP
#-------------------------------------------------------------------------------
EBDXAnimations.defineCommonAnimation(:WRAP) do
  vector = @scene.getRealVector(@targetIndex, @targetIsPlayer)
  factor = @targetIsPlayer ? 2 : 1.5
  # set up animation
  fp = {}
