...
GameData::Cutscene.define :ch1_breakfast_with_family do |scene|
  ...
  scene.message "The kitchen was lively this morning."
  scene.message "Mom had maps spread across the table between breakfast plates."
  scene.message "Dad was polishing an old Pokéball."
...
GameData::Cutscene.define :ch2_ragnar_route do |scene|
  ...
  scene.message "\\bRagnar\\b: YO! \\PN! OVER HERE!"
...
GameData::Cutscene.define :ch3_hooded_figures do |scene|
  ...
  scene.message "\\bKael\\b: See what?"
  scene.message "\\bLyra\\b: Those people in hoods... they were staring at us."
...
GameData::Cutscene.define :ch3_ragnar_festival do |scene|
  ...
  scene.message "\\bRagnar\\b: I'M TELLING YOU, MY PIKACHU CAN EAT MORE!"
  scene.message "\\bVendor\\b: Sir, that's not how the eating contest—"
  scene.message "\\bRagnar\\b: COME ON BUDDY, SHOW 'EM!"
...
GameData::Cutscene.define :ch3_dance_festival do |scene|
  ...
  scene.message "\\bLyra\\b: *tugging Kael's arm* Come on, let's dance!"
  scene.message "\\bKael\\b: Absolutely not."
  scene.message "\\bLyra\\b: Please? \\PN, help me convince him!"
  
  scene.message "\\b\\PN\\b: It could be fun, Kael."
  scene.message "\\bKael\\b: I don't dance. Ever."
...
GameData::Cutscene.define :ch3_firework_setup do |scene|
  ...
  scene.message "\\bLyra\\b: I know the perfect spot to watch!"
  scene.message "\\bLyra\\b: There's a hill overlooking the whole town!"
  
  scene.message "\\bKael\\b: How do you know about that?"
  scene.message "\\bLyra\\b: Elena told me. She came here on her journey."
  scene.message "\\bLyra\\b: She said it was... magical."
  
  scene.message "\\b\\PN\\b: Lead the way then."
...
GameData::Cutscene.define :ch3_shadow_stalker do |scene|
  ...
  scene.message "\\bShadow\\b: Zor... zor..."
  scene.message "\\bKael\\b: What is it, girl?"
  
  scene.message "Movement in the alley. A hooded figure."
  scene.message "Not running this time. Watching."
  
  scene.message "\\b\\PN\\b: Hey! Who are you?!"
  
  scene.message "The figure tilted their head."
  scene.message "\\bHooded Figure\\b: ...Soon."
  scene.message "And vanished into the shadows."
  
  scene.message "\\bLyra\\b: That was creepy!"
  scene.message "\\bKael\\b: They're following us specifically."
  scene.message "\\bKael\\b: We need to be careful."
  
  scene.message "\\b\\PN\\b: Agreed. Everyone stay alert."
...
GameData::Cutscene.define :ch3_morning_after do |scene|
  ...
  scene.message "\\bLyra\\b: *stretching* That was amazing!"
  scene.message "\\bLyra\\b: Best festival ever!"
  
  scene.message "\\bKael\\b: It was... informative."
  scene.message "\\bKael\\b: Those legends aren't just stories."
  scene.message "\\bKael\\b: Someone knows something about us."
  
  scene.message "\\b\\PN\\b: The storyteller, the mask merchant..."
  scene.message "\\b\\PN\\b: They reacted to us specifically."
  
  scene.message "\\bLyra\\b: And those hooded figures!"
  scene.message "\\bLyra\\b: What do they want with us?"
  
  scene.message "\\bKael\\b: I don't know. But we need answers."
  scene.message "\\bKael\\b: The dream mentioned a forest temple."
  
  scene.message "\\b\\PN\\b: Then that's where we go next."
  scene.message "\\bLyra\\b: Adventure awaits!"
...
GameData::Cutscene.define :ch14_xerneas_named do |scene|
  ...
  scene.message "\\bLyra\\b: At the name, Lyra's mark flared with rainbow light."
...
GameData::Cutscene.define :ch20_approaching_world_tree do |scene|
  scene.play_bgm 'Pokemon RSE - Tension'
  
  scene.message "The trees grew larger. More ancient."
  scene.message "And more corrupted."
  
  scene.message "\\bElena\\b: We're close."
  scene.message "\\bElena\\b: The World Tree is just ahead."
...
GameData::Cutscene.define :ch25_after_funeral do |scene|
  ...
  scene.message "The Zoroark understood. She always did."
...
GameData::Cutscene.define :ch25_entering_ruins do |scene|
  ...
  scene.message "The Zoroark's eyes glowed in the darkness."
...
GameData::Cutscene.define :ch25_5_shadow_evolves do |scene|
  scene.play_bgm 'Pokemon XY - Evolution'
  scene.camera_flash 20
  ...
  scene.message "\\bShadow\\b: ZORUAAAAAA...!"
  
  scene.message "She grew. Changed. Transformed."
  scene.message "A Zoroark now."
  scene.message "Magnificent. Powerful. Protective."
  
  scene.message "\\bShadow (Zoroark)\\b: ZOROARK!"
...
GameData::Cutscene.define :ch25_5_morwen_battle do |scene|
  ...
  scene.message "No longer the scared Zorua you'd rescued."
  scene.message "But a true partner."
...
GameData::Cutscene.define :ch25_5_lyra_acknowledgment do |scene|
  ...
  scene.message "\\bShadow (Zoroark)\\b: Zor..."
...
GameData::Cutscene.define :ch26_kael_reflection do |scene|
  ...
  scene.message "Shadow—now Zoroark—curled beside you."
  scene.message "\\bShadow\\b: Zoroark..."
