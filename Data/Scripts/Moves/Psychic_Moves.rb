#===============================================================================
# Shattered Crowns - Psychic Type Move Definitions
#===============================================================================
...
GameData::Move.define :GUARDSPLIT do |m|
  ...
  m.flags         :CanProtect, :ZPower_SPEED_1
...
GameData::Move.define :HEALBLOCK do |m|
  ...
  m.flags         :CanProtect, :CanMirrorMove, :ZPower_SPECIAL_ATTACK_2
...
GameData::Move.define :HEALPULSE do |m|
  ...
  m.flags         :CanProtect, :Pulse, :ZPower_ResetStats
...
GameData::Move.define :MAGICPOWDER do |m|
  ...
  m.flags         :CanProtect, :CanMirrorMove, :Powder, :ZPower_SPECIAL_ATTACK_1
...
GameData::Move.define :ROLEPLAY do |m|
  ...
  m.flags         :IgnoresMaxGuard, :ZPower_SPEED_1
...
GameData::Move.define :TRICKROOM do |m|
  ...
  m.flags         :CanMirrorMove, :ZPower_ACCURACY_1
