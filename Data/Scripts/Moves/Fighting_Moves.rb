#===============================================================================
# Shattered Crowns - Fighting Type Move Definitions
#===============================================================================
...
GameData::Move.define :FOCUSPUNCH do |m|
  ...
  m.flags         :Contact, :CanProtect, :Punching
...
GameData::Move.define :AURASPHERE do |m|
  ...
  m.total_pp      20
  m.target        :Other
  m.flags         :CanProtect, :CanMirrorMove, :Pulse, :Bomb
...
GameData::Move.define :COACHING do |m|
  ...
  m.flags         :CanMirrorMove, :ZPower_ATTACK_1
