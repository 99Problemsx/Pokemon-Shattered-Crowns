...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ".exe"
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "D:/a/mkxp-z-ext/mkxp-z-ext/windows/build-mingw64")
  ...
  CONFIG["configure_args"] = " '--prefix=/d/a/mkxp-z-ext/mkxp-z-ext/windows/build-mingw64' '--prefix=D:/a/mkxp-z-ext/mkxp-z-ext/windows/build-mingw64' '--enable-install-static-library' '--disable-install-doc' '--without-ext=openssl,readline,dbm,gdbm,win32ole' '--with-static-linked-ext' '--disable-rubygems' '--without-gmp' 'CC=gcc' 'CFLAGS=-std=gnu99 -flto -I/d/a/mkxp-z-ext/mkxp-z-ext/windows/build-mingw64/include -O3' 'LDFLAGS=-flto -L/d/a/mkxp-z-ext/mkxp-z-ext/windows/build-mingw64/lib'"
  ...
  CONFIG["DLDFLAGS"] = "-flto -L/d/a/mkxp-z-ext/mkxp-z-ext/windows/build-mingw64/lib -Wl,--enable-auto-image-base,--enable-auto-import"
  CONFIG["ALLOCA"] = ""
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  CONFIG["cleanlibs"] = ""
  ...
  CONFIG["LDFLAGS"] = "-L. -flto -L/d/a/mkxp-z-ext/mkxp-z-ext/windows/build-mingw64/lib -Wl,--no-as-needed"
  CONFIG["CFLAGS"] = "-std=gnu99 -flto -I/d/a/mkxp-z-ext/mkxp-z-ext/windows/build-mingw64/include -O3"
